BRACKET_TOKS="""/* The following tokens are for the Bracket Expression
...
BASIC="""%token    ORD_CHAR QUOTED_CHAR DUP_COUNT
...
%s
""" % (BRACKET_TOKS, BRACKET_EXPR)

EXTENDED="""%token  ORD_CHAR QUOTED_CHAR DUP_COUNT
